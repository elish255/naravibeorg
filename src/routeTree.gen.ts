...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/register' | '/payment' | '/dashboard' | '/chat/$slug' | '/admin' | '/login'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/register' | '/payment' | '/dashboard' | '/chat/$slug' | '/admin' | '/login'
  id: '__root__' | '/' | '/register' | '/payment' | '/dashboard' | '/chat/$slug' | '/admin' | '/login'
  fileRoutesById: FileRoutesById
}
export interface RootRouteChildren { IndexRoute: typeof IndexRoute; RegisterRoute: typeof RegisterRoute; PaymentRoute: typeof PaymentRoute; DashboardRoute: typeof DashboardRoute; ChatSlugRoute: typeof ChatSlugRoute; AdminRoute: typeof AdminRoute; LoginRoute: typeof LoginRoute }
...
const rootRouteChildren: RootRouteChildren = { IndexRoute, RegisterRoute, PaymentRoute, DashboardRoute, ChatSlugRoute, AdminRoute, LoginRoute }
