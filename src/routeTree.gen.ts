...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/register' | '/login' | '/payment' | '/dashboard' | '/chat/$slug' | '/admin'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/register' | '/login' | '/payment' | '/dashboard' | '/chat/$slug' | '/admin'
  id: '__root__' | '/' | '/register' | '/login' | '/payment' | '/dashboard' | '/chat/$slug' | '/admin'
  fileRoutesById: FileRoutesById
}
export interface RootRouteChildren { IndexRoute: typeof IndexRoute; RegisterRoute: typeof RegisterRoute; LoginRoute: typeof LoginRoute; PaymentRoute: typeof PaymentRoute; DashboardRoute: typeof DashboardRoute; ChatSlugRoute: typeof ChatSlugRoute; AdminRoute: typeof AdminRoute }
...
const rootRouteChildren: RootRouteChildren = { IndexRoute, RegisterRoute, LoginRoute, PaymentRoute, DashboardRoute, ChatSlugRoute, AdminRoute }
