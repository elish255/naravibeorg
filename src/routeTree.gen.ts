...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/register' | '/payment' | '/dashboard' | '/chat/$slug' | '/admin'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/register' | '/payment' | '/dashboard' | '/chat/$slug' | '/admin'
  id: '__root__' | '/' | '/register' | '/payment' | '/dashboard' | '/chat/$slug' | '/admin'
  fileRoutesById: FileRoutesById
}
export interface RootRouteChildren { IndexRoute: typeof IndexRoute; RegisterRoute: typeof RegisterRoute; PaymentRoute: typeof PaymentRoute; DashboardRoute: typeof DashboardRoute; ChatSlugRoute: typeof ChatSlugRoute; AdminRoute: typeof AdminRoute }
...
const rootRouteChildren: RootRouteChildren = { IndexRoute, RegisterRoute, PaymentRoute, DashboardRoute, ChatSlugRoute, AdminRoute }
